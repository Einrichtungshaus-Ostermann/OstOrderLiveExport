...
namespace OstOrderLiveExport;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstOrderLiveExport extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_order_live_export.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_order_live_export.view_dir', $this->getPath() . '/Resources/views/');
